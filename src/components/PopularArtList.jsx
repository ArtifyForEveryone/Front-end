...
const PopularArtList = () => {
    const [artwork, setArtwork] = useState([]);
    const [isLoading, setIsLoading] = useState(true);

    const fetchData = async () => {
        try {
            const response = await axios.get(`http://localhost:8080/api/auth/artworkList/mostPopular`);
    ...
    return (
        <div>
            <div className='pb-10 h-full mb-20'>
                <h1 className='text-center mb-20 uppercase text-4xl text-[#2f6a81] font-bold'>Popular Artworks</h1>
