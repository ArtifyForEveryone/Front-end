...
const NewMemberArtist = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            const response = await axios.get(
                "http://localhost:8080/api/auth/creatorList/newCreators",
            );
            if (response) {
    ...
    return (
        <div className='h-full pb-10 mb-20'>
            <h1 className='text-center mb-20 uppercase text-4xl text-[#2f6a81] font-bold'>New Members</h1>
                        ...
                        <Card key={index} className='h-[280px]'>
                            <div className="flex flex-col items-center">
                                ...
                                <div className="flex justify-between items-center">
                                    <span className="font-normal text-gray-500 mr-2">Joined in:</span>
...
export default NewMemberArtist