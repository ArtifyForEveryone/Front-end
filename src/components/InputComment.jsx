    ...
    <div className="flex mt-4 gap-3 mx-5">
      ...
      <div className="grow rounded-lg border ">
        <form className="flex">
          ...
          />
          <div onClick={handleKeyPress} className="cursor-pointer sm:flex h-10 gap-2 hidden items-center text-gray-600 bg-gray-200 px-4 rounded-e-lg hover:text-white hover:bg-[#2f6a81] hover:font-semibold transition-all duration-300">
            <button>Send</button>
          </div>
        </form>
      </div>
